...
- `!!/report-force <post URL 1> [<post URL 2> [...]] ["custom reason"]` — Same as `!!/report`, but causes SmokeDetector to ignore the active instance's record of the post being recently reported.
